...
export default function AvcbFilters({
  filtros,
  onFiltroChange,
  onLimparFiltros,
  gerentes = []
  ...
  return (
    <div className="avcb-filters-card">
      {/* 1. Busca por Nome / Código */}
      <div className="avcb-filter-group busca">
        <label className="avcb-filter-label">Buscar condomínio</label>
      ...
      <div className="avcb-filter-group">
        <label className="avcb-filter-label">Gerente</label>
        <select
      ...
      {/* 3. Situação */}
      <div className="avcb-filter-group">
        <label className="avcb-filter-label">Situação</label>
        <select
          className="avcb-select"
      ...
      {/* 4. Validade entre */}
      <div className="avcb-filter-group datas">
        <label className="avcb-filter-label">Validade entre</label>
        <div className="avcb-date-range">
          <input
            type="date"
            className="avcb-input"
      ...
      <div>
        <button type="button" className="avcb-btn-clear" onClick={onLimparFiltros}>
